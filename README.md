...
This folder cointains Jupyter notebook that were used to perform monte carlo analysis of the dataset (jupyter notebook for exploration, testing, and visualisation). This folder also cointains simulation results.
